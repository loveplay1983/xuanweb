...
CKEDITOR.plugins.setLang( 'filetools', 'pt', {
	...
	httpError404: 'HTTP error occurred during file uploads (404: File not found).', // MISSING
	httpError403: 'HTTP error occurred during file uploads (403: Forbidden).', // MISSING
	httpError: 'HTTP error occurred during file uploads (error status: %1).', // MISSING
